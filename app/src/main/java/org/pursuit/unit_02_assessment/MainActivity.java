...
public class MainActivity extends AppCompatActivity
    ...
    static String KEY = "result";
    static String VALUE = "You have guessed correctly!";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent sendEmail = new Intent(Intent.ACTION_SENDTO, Uri.parse("mailto:mail.pursuit.org"));
                sendEmail.putExtra(Intent.EXTRA_SUBJECT, "Email from Pursuit");
                sendEmail.putExtra(Intent.EXTRA_TEXT, "This is my text!");
        ...
        final int numberSelected = randomGame.getRandomNumber();
        submitButton = (Button)findViewById(R.id.submit_button);
        submitButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                inputEditText = (EditText)findViewById(R.id.number_edittext);
                if(Integer.parseInt(inputEditText.getText().toString()) == numberSelected){
                    Intent intent = new Intent(MainActivity.this, SecondActivity.class);
                    intent.putExtra(KEY,VALUE);
                }
                else{
                    TextView tv = findViewById(R.id.info_textview);
                    tv.setText(getString(R.string.wrong_guess));
                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_toast) {
            ...
            Toast.makeText(MainActivity.this,"Hello Pursuit", Toast.LENGTH_SHORT).show();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        int id = item.getItemId();
         switch (id) {
             ...
             case R.id.nav_phone:
                 Uri uri1 = Uri.parse("tel:2125551212");
                 Intent phoneDial = new Intent(Intent.ACTION_DIAL,uri1);
                 startActivity(phoneDial);
                 return true;

             case R.id.nav_sms:
                 Uri uri2 = Uri.parse("smsto:2125551212");
                 Intent sendText = new Intent(Intent.ACTION_SENDTO,uri2);
                 sendText.putExtra("sms_body ","Welcome to Pursuit");
                 startActivity(sendText);
                 return true;

             case R.id.nav_map_location:
                 Uri uri3 = Uri.parse("geo:0,0?q=40.7429595,-73.94192149999998(Pursuit Android HQ)");
                 Intent getLoc = new Intent(Intent.ACTION_VIEW,uri3);
                 getLoc.setPackage("com.google.android.apps.maps");
